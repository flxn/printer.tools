export const resources = [
  ...
  },
  {
    ...
    slug: 'meshcast',
    category: 'Tools',
    description: 'Browser-based collection of 3D generators for creating print-ready molds, cookie cutters, name signs, planters, stamps, keychains, lithophanes, and more. MeshCast requires no installation and offers five free STL downloads per day.',
    shortDescription: 'Generate printable molds and maker projects in your browser',
    icon: '/icons/meshcast.svg',
    screenshot: '/screenshots/meshcast.jpg',
    website: 'https://meshcast.app/',
    price: 'Free (Pro available)',
    platforms: ['Web'],
    tags: ['Generator', 'Molds', 'STL', 'Cookie Cutters', 'Lithophane', 'Maker Tools']
  },
  {
    id: 'bumpmesh',
    name: 'BumpMesh',
    slug: 'bumpmesh',
    category: 'Tools',
    description: 'Free browser-based tool by CNC Kitchen for adding displacement textures to STL, OBJ, and 3MF models. Choose a texture and projection, control the displacement and masking, preview the result, and export a print-ready textured mesh without uploading the model.',
    shortDescription: 'Add displacement textures to 3D models locally in your browser',
    icon: '/icons/bumpmesh.png',
    screenshot: '/screenshots/bumpmesh.jpg',
    website: 'https://bumpmesh.com/',
    price: 'Free',
    platforms: ['Web'],
    tags: ['Textures', 'Displacement', 'STL', '3MF', 'OBJ', 'Mesh', 'Local Processing']
  },
  {
    id: 'bento3d',
    name: 'Bento3D',
